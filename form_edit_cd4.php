                                    ...
                                    <table width="100%" class="table table-responsive">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>% Lymphocytes</td>
                                                <td>
                                                    <input type="number" class="form-control" step="0.01" id="<?=strtolower(str_replace(' ','_','Lymphocytes'))?>" name="<?=strtolower(str_replace(' ','_','Lymphocytes'))?>" value="<?=$result_current_data['lymphocytes']?>" onchange="cal_ab_lymphocyte($('#wbc_counts').val(),$(this).val())">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    value="<?=$result_current_data[strtolower(str_replace(' ','_','NK cell'))]?>">
                                                </td>
                                                <td class="text-center">%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    value="<?=$result_current_data[strtolower(str_replace(' ','_','B cell'))]?>">
                                                </td>
                                                <td class="text-center">%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    value="<?=$result_current_data[strtolower(str_replace(' ','_','T cell CD3'))]?>">
                                                </td>
                                                <td class="text-center">%</td>
...
-->
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" step="0.01" id="<?=strtolower(str_replace(' ','_','T cell CD4'))?>" name="<?=strtolower(str_replace(' ','_','T cell CD4'))?>" value="<?=$result_current_data['cd4_value']?>" onchange="cal_ab_lymphocyte($('#wbc_counts').val(),$('#lymphocytes').val())">
                                                </td>
                                                <td class="text-center">%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" step="0.001" id="<?=strtolower(str_replace(' ','_','T cell CD8'))?>" name="<?=strtolower(str_replace(' ','_','T cell CD8'))?>" value="<?=$result_current_data['cd8_value']?>" onchange="cal_ab_lymphocyte($('#wbc_counts').val(),$('#lymphocytes').val())">
                                                </td>
                                                <td class="text-center">%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>WBC counts</td>
                                                <td>
                                                    <input type="number" class="form-control" step="0.01" id="<?=strtolower(str_replace(' ','_','WBC counts'))?>" name="<?=strtolower(str_replace(' ','_','WBC counts'))?>" value="<?=$result_current_data['wbc']?>" onchange="cal_ab_lymphocyte($(this).val(),$('#lymphocytes').val())">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    value="<?=$result_current_data[strtolower(str_replace(' ','_','CD4 CD8 Ratio'))]?>">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    value="<?=$result_current_data[strtolower(str_replace(' ','_','Absolute Lymphocyted'))]?>">
                                                </td>
                                                <td class="text-center">cells/cu.mm</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    value="<?=$result_current_data[strtolower(str_replace(' ','_','Absolute T cells'))]?>">
                                                </td>
                                                <td class="text-center">cells/cu.mm</td>
...
-->
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" step="0.01" id="<?=strtolower(str_replace(' ','_','Absolute T helper cells'))?>" name="<?=strtolower(str_replace(' ','_','Absolute T helper cells'))?>" value="<?=$result_current_data['percent_cd4']?>">
                                                </td>
                                                <td class="text-center">cells/mm<sup>3</sup></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" step="0.01" id="<?=strtolower(str_replace(' ','_','Absolute T suppressor cells'))?>" name="<?=strtolower(str_replace(' ','_','Absolute T suppressor cells'))?>" value="<?=$result_current_data['percent_cd8']?>">
                                                </td>
                                                <td class="text-center">cells/mm<sup>3</sup></td>
