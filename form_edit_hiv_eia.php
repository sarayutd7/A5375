                            ...
                            <div class="form-group">
                                <div class="col-lg-3 col-sm-6 col-lg-offset-5 col-sm-offset-4">
                                    <select id="eia_status" name="eia_status" class="form-control">
                                        <option value=""></option>
                                        <option value="Negative" <? if($result_current_data['eia']=='Negative' ){ echo "selected" ; }?>>Negative</option>
                                        <option value="Positive" <? if($result_current_data['eia']=='Positive' ){ echo "selected" ; }?>>Positive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
