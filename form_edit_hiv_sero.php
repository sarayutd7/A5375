...
<div class="row">
    <div class="col-lg-12 col-sm-12">
        <section class="panel">
            <form action="update_sero.php" enctype="multipart/form-data" method="post">
                <header class="panel-heading">
                    <h2 class="panel-title">Edit HIV Confirmatory Report</h2>
                </header>
                                ...
                                <div class="col-lg-8 col-sm-12 col-xs-12 col-lg-offset-3">
                                    <table class="table table-responsive" border="1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center"><?=seletion_obj('gp36',$result_current_data['gp36'])?>
                                                </td>
                                                <td class="text-center">
                                                    <?=seletion_obj('gp140',$result_current_data['gp140'])?>
                                                </td>
                                                <td class="text-center">
                                                    <?=seletion_obj('p31',$result_current_data['p31'])?>
                                                </td>
                                                <td class="text-center">
                                                    <?=seletion_obj('gp160',$result_current_data['gp160'])?>
                                                </td>
                                                <td class="text-center">
                                                    <?=seletion_obj('p24',$result_current_data['p24'])?>
                                                </td>
                                                <td class="text-center">
                                                    <?=seletion_obj('gp41',$result_current_data['gp41'])?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
