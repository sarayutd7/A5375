<div class="col-lg-6 col-md-6 form-group ">CD4, CD8 T Cells Record All</div>
<div class="col-lg-6 col-md-6 form-group text-right">
    <button class=" btn btn-sm btn-success" onclick="location.replace('index.php?task=create_cd4&pid=<?=$_GET['pid']?>')"><i class="fa fa-file"></i> Create</button>
...
<div>
    <table class="table table-bordered table-striped mb-none" id="datatable-cd4">
        <thead>
            <tr>
                <th>Visit Code</th>
                <th>Date Coll</th>
        ...
        <tbody>
            <?
    $get_task = 'cd4';
    $sql_eia = "select * from cd4 where ptid = '".$_GET['pid']."' order by visit_code desc";
