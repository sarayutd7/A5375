<div class="col-lg-6 col-md-6 form-group ">HIV Record All </div>
<div class="col-lg-6 col-md-6 form-group text-right">
    <button class=" btn btn-sm btn-success" onclick="location.replace('index.php?task=create_hiv&pid=<?=$_GET['pid']?>')"><i class="fa fa-file"></i> Create</button>
...
<div>
    <table class="table table-bordered table-striped mb-none" id="datatable-details">
        ...
        <tbody>
            <?
    $get_task = 'hiv';
    $sql_hivcon = "select * from hiv where ptid = '".$_GET['pid']."' order by visit_code desc";
