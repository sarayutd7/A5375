<div class="col-lg-6 col-md-6 form-group ">HIV EIA <sup>4th</sup> Generation</div>
<div class="col-lg-6 col-md-6 form-group text-right">
    <button class=" btn btn-sm btn-success" onclick="location.replace('index.php?task=create_hiv_eia&pid=<?=$_GET['pid']?>')"><i class="fa fa-file"></i> Create</button>
...
<div>
    <table class="table table-bordered table-striped mb-none" id="datatable-hiveia">
        ...
        <tbody>
            <?
    $get_task = 'hiv_eia';
    $sql_eia = "select * from hiv_eia where ptid = '".$_GET['pid']."' order by visit_code desc";
