<div class="col-lg-6 col-md-6 form-group ">HIV-1 RNA PCR</div>
<div class="col-lg-6 col-md-6 form-group text-right">
    <button class=" btn btn-sm btn-success" onclick="location.replace('index.php?task=create_hiv_rna&pid=<?=$_GET['pid']?>')"><i class="fa fa-file"></i> Create</button>
...
<div>
    <table class="table table-bordered table-striped mb-none" id="datatable-hivrna">
        <thead>
            <tr>
                <th>Visit Code</th>
                <th>Date Coll</th>
        ...
        <tbody>
            <?
    $get_task = 'hiv_rna';
    $sql_eia = "select * from hiv_rna where ptid = '".$_GET['pid']."' order by visit_code desc";
