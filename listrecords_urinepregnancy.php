<div class="col-lg-6 col-md-6 form-group ">Urine Pregnancy Record all</div>
<div class="col-lg-6 col-md-6 form-group text-right">
    <button class=" btn btn-sm btn-success" onclick="location.replace('index.php?task=create_urinepregnancy&pid=<?=$_GET['pid']?>')"><i class="fa fa-file"></i> Create</button>
...
<div>
    <table class="table table-bordered table-striped mb-none" id="datatable-urinepregnancy">
        <thead>
            <tr>
                <th>Visit Code</th>
                <th>Date Coll</th>
        ...
        <tbody>
<?
    $get_task = 'urinepregnancy';
    $sql_eia = "select * from urinepregnancy where ptid = '".$_GET['pid']."' order by visit_code desc";
