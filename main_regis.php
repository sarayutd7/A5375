<div class="row">
    <form action="index.php?task=regis_data" enctype="multipart/form-data" method="post">
        <div class="col-lg-12">
            <section class="panel">
...
-->
                    ...
                    <h2 class="panel-title">Register PID</h2>
                </header>
                            ...
                            <div class="form-group">
                                <div class="clo-sm-12 col-md-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" placeholder="XXXXXXXY" type="text" id="pid" name="pid" value="<?=strtoupper($_GET['pid'])?>" style="text-transform:uppercase" required>
                                    </div>
                                </div>
                                ...
                                <div class="clo-sm-12 col-md-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" data-plugin-datepicker type="text" name="dob" id="dob" onchange="check_age_regis(this.value,'00:01')" required>
                                    </div>
                                </div>
                                <? } ?>
                                ...
                                <div class="clo-sm-12 col-md-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" data-plugin-masked-input="" data-input-mask="99:99" placeholder="__:__"  id="dob_time" name="dob_time" required>
                                    </div>
                                </div>
                                <? } ?>
...
<!--
                                <div class="clo-sm-12 col-md-6 form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <i class="glyphicon glyphicon-calendar"></i> Premature birth or not
                                        </span>
                                        <select class="form-control" id="premature" name="premature" required>
                                        <option value="0">Please  Select</option>
                                        <option value="p">Preterm</option>
...
-->
                                ...
                                <div class="clo-sm-12 col-md-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" id="age" name="age" placeholder="00.0" step=0.01 required>
                                    </div>
                                </div> 
                                ...
                                <div class="clo-sm-12 col-md-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="number" id="weight" name="weight" placeholder="00.00" step=0.01 required>
