...
if($nr_titlename>0){?>
                        ...
                        for($t=0;$t<$nr_titlename;$t++){ ?>
                            <? if($result_userLogin['titlename'] == $result_titlename[$t]['titlename_id']){ ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="firstname" name="firstname" class="form-control" value="<?=$result_userLogin['fristname']?>">
                        <input type="hidden" id="uid" name="uid" class="form-control" value="<?=$result_userLogin['id']?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">Last Name: </label>
                    <div class="col-sm-8">
                        <input type="text" id="lastname" name="lastname" class="form-control" value="<?=$result_userLogin['lastname']?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">Your Email: </label>
                    <div class="col-sm-8">
                        <input type="email" id="email" name="email" class="form-control" value="<?=$result_userLogin['email']?>">
                    </div>
                </div>
                <hr>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="password" id="currentpass" name="currentpass" class="form-control" value="<?=$result_userLogin['password']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="status" name="status" class="form-control" value="<?=position($result_userLogin['status'])?>" readonly>
                        <input type="hidden" id="statusID" name="statusID" class="form-control" value="<?=$result_userLogin['status']?>">
                    </div>
                </div>
            </div>
