<div id="code">
    <table width="100%" border="0" cellspacing="5" cellpadding="5" class="table table-bordered table-striped table-hover">
        <thead class="bg-success">
            <tr>
                <th colspan="4" class="text-center">Table  HIV Confirmatory Test</th>
            </tr>
            <tr>
                <th class="text-center"><input type="checkbox" name="cbox_all" id="cbox_all" value="all" onClick="CheckAll(this);isChecked(this.checked)" />&nbsp;
                    <input name="tbname" id="tbname" type="hidden" value="hiv_sero" /></th>
                <th>Name</th>
                <th>Type</th>
                <th>Description</th>
            </tr>
  ...
  "gp36"=>array("varchar(75)"=>"HIV EIA: Result"),
  "gp140"=>array("varchar(75)"=>"NULL"),
  "p31"=>array("varchar(75)"=>"NULL"),
  "gp160"=>array("varchar(75)"=>"NULL"),
  "p24"=>array("varchar(75)"=>"NULL"),
  "gp41"=>array("varchar(75)"=>"NULL"),
  "hiv1"=>array("varchar(75)"=>"NULL"),
  "hiv2"=>array("varchar(75)"=>"NULL"),
