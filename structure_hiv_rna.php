<div id="code">
    <table width="100%" border="0" cellspacing="5" cellpadding="5" class="table table-bordered table-striped table-hover">
        <thead class="bg-success">
            <tr>
                <th colspan="4" class="text-center">Table HIV RNA PCR</th>
            </tr>
            <tr>
                <th class="text-center"><input type="checkbox" name="cbox_all" id="cbox_all" value="all" onClick="CheckAll(this);isChecked(this.checked)" />&nbsp;
                    <input name="tbname" id="tbname" type="hidden" value="hiv_rna" /></th>
                <th>Name</th>
                <th>Type</th>
                <th>Description</th>
            </tr>
  ...
  "rna"=>array("varchar(20)"=>"HIV-1 RNA PCR: Result"),
  "rna_date_assa"=>array("date"=>"HIV-1 RNA PCR: Date Assayed"),
  "rna_time_assa"=>array("time "=>"NULL"),
  "viral_copies"=>array("varchar(100)"=>"NULL"),
  "log_copies"=>array("varchar(100)"=>"NULL"),
