...
if($_SESSION['session_userid']!=''){ 
        ...
        case 'urine' : 
            if($_POST['urine_radio']=='ng'){
                $syntax_sql_urine = "urine_specimen = '".$_POST['ctng_speci']."',
                           ...
                           urine_neisseria_date = '".date('Y-m-d',strtotime(str_replace('/', '-', $_POST['date_assay_urint_ng'])))."',
               ...
               $syntax_sql_urine = "urine_specimen = '".$_POST['ctng_speci']."',
                           ...
                           urine_chiamydia_date = '".date('Y-m-d',strtotime(str_replace('/', '-', $_POST['date_assay_urint_ct'])))."',
         ...
         case 'rectal_swab' :  
            if($_POST['rs_radio']=='ng'){
                $syntax_sql_rectal = "rectal_swab_specimen = '".$_POST['ctng_speci']."',
                           ...
                           rectal_swab_neisseria_date = '".date('Y-m-d',strtotime(str_replace('/', '-', $_POST['date_assay_rs_ng'])))."',
               ...
               $syntax_sql_rectal = "rectal_swab_specimen = '".$_POST['ctng_speci']."',
                           ...
                           rectal_swab_chiamydia_date = '".date('Y-m-d',strtotime(str_replace('/', '-', $_POST['date_assay_rs_ct'])))."',
    ...
    $insert_sql = "update ctng set visit_code = '".$_POST['visit_code']."',
